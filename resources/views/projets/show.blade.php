...
@section('content')
    <div class="container mt-4">
        ...
        <div class="card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            ...
            <div class="card-body">
                <h1>
                    <p><strong>Titre :</strong> {{ $projets->titre }}</p>
                </h1>
                ...
                <div class="d-flex justify-content-between ">
                    ...
                    @endif
                    <div class="modal fade" id="correctionModal" tabindex="-1" aria-labelledby="correctionModalLabel"
                    aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="message" id="message" rows="5" class="form-control"
                                            placeholder="Indiquez les éléments à corriger..." required></textarea>
                                    </div>
                                </div>
                ...
                @if($projets->correction_Requests->isNotEmpty())
                <div class="alert alert-warning">
                    ⚠️ Ce projet a {{ $projets->correction_Requests->count() }} demande(s) de correction :
                    <ul>
                        @foreach($projets->correction_Requests as $correction)
                            <li>{{ $correction->message }} — le {{ $correction->created_at->format('d/m/Y') }}</li>
                        @endforeach
                    </ul>
                </div>
            @endif
